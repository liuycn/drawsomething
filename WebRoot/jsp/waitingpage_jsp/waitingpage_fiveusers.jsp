...
<body>
<div id="changePageContent_fiveusers">
...
<div id="userList_waitingPage">
	...
	<table class="secondRow"><!-- 第二行 -->
	<tr>
	
	<td id="fourthUser" class="secondRow">
		<div class="profilePicture">
		<img id="profilePicture4" class="propic" alt="匹配中……" src="picture/waiting/waiting.gif">
		</div>
		<span id="userInfo4">userInfo4</span><!-- userName+score -->
	</td>
	<td id="fifthUser" class="secondRow">
		<div class="profilePicture">
		<img id="profilePicture5" class="propic" alt="匹配中……" src="picture/waiting/waiting.gif">
		</div>
		<span id="userInfo5">userInfo5</span>
	</td>
